  ...
  render() {
    return (
      <div>
        ...
        <Link className='subnav' to ="/about"><h3>About</h3></Link>
        <Link className='subnav'to = '/about/history'><h3>History</h3></Link>
        <Link className='subnav' to ='/about/contact'><h3>Contact</h3></Link>
        </div>
        <div className='box'>
        <Switch>
          <Route path ="/about/history" className='subnav_links' component={History}/>
          <Route path ="/about/contact" className='subnav_links' component={Contact}/>
